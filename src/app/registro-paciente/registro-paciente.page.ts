...
import { IonContent, IonItem, IonLabel, IonButton, IonHeader, IonToolbar, IonTitle, IonIcon, IonCol, IonRow, IonGrid, IonInput } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonGrid, IonRow, IonCol, IonTitle, IonToolbar, IonHeader, IonButton, IonContent, CommonModule, FormsModule, IonItem, IonInput, IonLabel]
})
